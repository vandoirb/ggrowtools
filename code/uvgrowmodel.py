...
if __name__ == "__main__":
    ...
    paleta = sns.color_palette("ch:2,r=.2,l=.6",as_cmap=True)
    #import cartopy
    
    filename = r'C:\Users\vando\OneDrive\ORIENTACOES\Mestrado\Elton\Weather DATA\1_Embrapa_diario_2016+2017+2018_1096days.txt'
    ...
    db = r'C:\Users\vando\Google Drive\DIGITAL_GLOBE_GRANT\shape_UFSCar.shp'
...
#        areasLAI = []
    ...
    fig = plt.figure()  
    #with writer.saving(fig, "teste_crescimento_ufscar.mp4", 100):
    for dia in df4.Data.unique():
        ...
        plt.clf()
        mapa = areas.plot(column='LAI',cmap=paleta, vmin=0.5, vmax=2.,linewidth=0)
